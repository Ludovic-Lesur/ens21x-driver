...
#ifndef __ENS21X_HW_H__
#define __ENS21X_HW_H__
...
/*!******************************************************************
 * \fn ENS21X_status_t ENS21X_HW_init(void)
 * \brief Init ENS21x hardware interface.
 * \param[in]   none
 * \param[out]  none
...
/*!******************************************************************
 * \fn ENS21X_status_t ENS21X_HW_de_init(void)
 * \brief Release ENS21x hardware interface.
 * \param[in]   none
 * \param[out]  none
 * \retval      Function execution status.
 *******************************************************************/
...
/*!******************************************************************
 * \fn ENS21X_status_t ENS21X_HW_i2c_write(uint8_t i2c_address, uint8_t* data, uint8_t data_size_bytes, uint8_t stop_flag)
...
/*!******************************************************************
 * \fn ENS21X_status_t ENS21X_HW_i2c_read(uint8_t i2c_address, uint8_t* data, uint8_t data_size_bytes)
...
/*!******************************************************************
 * \fn ENS21X_status_t ENS21X_HW_delay_milliseconds(uint32_t delay_ms)
